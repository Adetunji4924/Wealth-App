...
const SelectCity = ({ optionsArray }) => {
    ...
    return (
      <div className="relative w-[50%] space-y-2" ref={dropdownRef}>
        {/* Input field for searching/selecting */}
        <label htmlFor="occupation" className="text-sm font-medium text-text2-0">City</label>
        <input
          type="text"
